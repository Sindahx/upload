...
public final class Validator
{
    ...
    {
        return "".equals(str) || "null".equals(str) || null == str;
    }
     ...
     */
    /*
     * public static boolean isGtLength(String str, int length) { if (isBlank(str)) { return false; } return
     * StringUtil.getLength(str.trim()) > length; }
     */
     ...
     */
    /*
     * public static boolean isLtLength(String str, int length) { if (isBlank(str)) { return false; } return
     * StringUtil.getLength(str.trim()) < length; }
     */
     ...
     */
    /*
     * public static boolean isIDcard(String str) { if (isBlank(str)) { return false; } Checker checker = new
     * Checker(str); return checker.check(); }
     */
