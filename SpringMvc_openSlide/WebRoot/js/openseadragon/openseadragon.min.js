...
window.OpenSeadragon = window.OpenSeadragon || function(a) {
	...
	function(a) {
		...
		a.extend = function() {
			var a, b, c, d, e, f, g = arguments[0] || {},
				...
				i = !1,
				j = 1;
			for ("boolean" == typeof g && (i = g, g = arguments[1] || {}, j = 2), "object" == typeof g || OpenSeadragon.isFunction(g) || (g = {}), h === j && (g = this, --j); h > j; j++)
				if (a = arguments[j], null !== a || void 0 !== a)
					for (b in a) c = g[b], d = a[b], g !== d && (i && d && (OpenSeadragon.isPlainObject(d) || (e = OpenSeadragon.isArray(d))) ? (e ? (e = !1, f = c && OpenSeadragon.isArray(c) ? c : []) : f = c && OpenSeadragon.isPlainObject(c) ? c : {}, g[b] = OpenSeadragon.extend(i, f, d)) : void 0 !== d && (g[b] = d));
			return g
		}, a.extend(a, {
			DEFAULT_SETTINGS: {
				xmlPath: null,
			...
			getElementPosition: function(c) {
				...
				for (c = a.getElement(c), d = "fixed" == a.getElementStyle(c).position, e = b(c, d); e;) f.x += c.offsetLeft, f.y += c.offsetTop, d && (f = f.plus(a.getPageScroll())), c = e, d = "fixed" == a.getElementStyle(c).position, e = b(c, d);
				return f
			},
			getElementOffset: function(b) {
				b = a.getElement(b);
				var c, d, e = b && b.ownerDocument,
					f = {
						top: 0,
						left: 0
					};
				return e ? (c = e.documentElement, "undefined" != typeof b.getBoundingClientRect && (f = b.getBoundingClientRect()), d = e == e.window ? e : 9 === e.nodeType ? e.defaultView || e.parentWindow : !1, new a.Point(f.left + (d.pageXOffset || c.scrollLeft) - (c.clientLeft || 0), f.top + (d.pageYOffset || c.scrollTop) - (c.clientTop || 0))) : new a.Point
			},
			getElementSize: function(b) {
				return b = a.getElement(b), new a.Point(b.clientWidth, b.clientHeight)
			},
			...
			getMousePosition: function(b) {
				if ("number" == typeof b.pageX) a.getMousePosition = function(b) {
					var c = new a.Point;
					return b = a.getEvent(b), c.x = b.pageX, c.y = b.pageY, c
				};
				else {
					if ("number" != typeof b.clientX) throw new Error("Unknown event mouse position, no known technique.");
					a.getMousePosition = function(b) {
						var c = new a.Point;
						return b = a.getEvent(b), c.x = b.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, c.y = b.clientY + document.body.scrollTop + document.documentElement.scrollTop, c
					}
				}
			...
			getPageScroll: function() {
				var b = document.documentElement || {},
					c = document.body || {};
				if ("number" == typeof window.pageXOffset) a.getPageScroll = function() {
					return new a.Point(window.pageXOffset, window.pageYOffset)
				};
				else if (c.scrollLeft || c.scrollTop) a.getPageScroll = function() {
					return new a.Point(document.body.scrollLeft, document.body.scrollTop)
				};
				else {
					if (!b.scrollLeft && !b.scrollTop) return new a.Point(0, 0);
			...
			setPageScroll: function(b) {
				if ("undefined" != typeof window.scrollTo) a.setPageScroll = function(a) {
					window.scrollTo(a.x, a.y)
				};
				else {
					var c = a.getPageScroll();
					if (c.x === b.x && c.y === b.y) return;
					document.body.scrollLeft = b.x, document.body.scrollTop = b.y;
					var d = a.getPageScroll();
					if (d.x !== c.x && d.y !== c.y) return void(a.setPageScroll = function(a) {
						document.body.scrollLeft = a.x, document.body.scrollTop = a.y
					});
					if (document.documentElement.scrollLeft = b.x, document.documentElement.scrollTop = b.y, d = a.getPageScroll(), d.x !== c.x && d.y !== c.y) return void(a.setPageScroll = function(a) {
			...
			getWindowSize: function() {
				var b = document.documentElement || {},
					c = document.body || {};
				if ("number" == typeof window.innerWidth) a.getWindowSize = function() {
					return new a.Point(window.innerWidth, window.innerHeight)
				};
				else if (b.clientWidth || b.clientHeight) a.getWindowSize = function() {
					return new a.Point(document.documentElement.clientWidth, document.documentElement.clientHeight)
				};
				else {
					if (!c.clientWidth && !c.clientHeight) throw new Error("Unknown window size, no known technique.");
			...
			makeCenteredNode: function(b) {
				...
				return a.extend(c[0].style, {
					...
					textAlign: "center"
				}), c[0].appendChild(c[1]), c[1].appendChild(c[2]), c[2].appendChild(b), c[0]
			},
			...
			makeTransparentImage: function(b) {
				return a.makeTransparentImage = function(b) {
					...
					var c = a.makeNeutralElement("img"),
						d = null;
					return d = a.makeNeutralElement("span"), d.style.display = "inline-block", c.onload = function() {
						d.style.width = d.style.width || c.width + "px", d.style.height = d.style.height || c.height + "px", c.onload = null, c = null
					}, c.src = b, d.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + b + "', sizingMethod='scale')", d
				}), a.makeTransparentImage(b)
			},
			setElementOpacity: function(b, c, d) {
				var e, f;
				b = a.getElement(b), d && !a.Browser.alpha && (c = Math.round(c)), a.Browser.opacity ? b.style.opacity = 1 > c ? c : "" : 1 > c ? (e = Math.round(100 * c), f = "alpha(opacity=" + e + ")", b.style.filter = f) : b.style.filter = ""
			},
			setElementTouchActionNone: function(b) {
				b = a.getElement(b), "undefined" != typeof b.style.touchAction ? b.style.touchAction = "none" : "undefined" != typeof b.style.msTouchAction && (b.style.msTouchAction = "none")
			},
			addClass: function(b, c) {
				b = a.getElement(b), b.className ? -1 === (" " + b.className + " ").indexOf(" " + c + " ") && (b.className += " " + c) : b.className = c
			},
			indexOf: function(a, b, c) {
				return this.indexOf = Array.prototype.indexOf ? function(a, b, c) {
					...
					for (0 > f && (f = e - Math.abs(f)), d = f; e > d; d++)
						if (a[d] === b) return d;
					return -1
				}, this.indexOf(a, b, c)
			},
			removeClass: function(b, c) {
				var d, e, f = [];
				for (b = a.getElement(b), d = b.className.split(/\s+/), e = 0; e < d.length; e++) d[e] && d[e] !== c && f.push(d[e]);
				b.className = f.join(" ")
			},
			addEvent: function() {
				if (window.addEventListener) return function(b, c, d, e) {
					b = a.getElement(b), b.addEventListener(c, d, e)
				};
				if (window.attachEvent) return function(b, c, d) {
					b = a.getElement(b), b.attachEvent("on" + c, d)
				};
				throw new Error("No known event model.")
			}(),
			removeEvent: function() {
				if (window.removeEventListener) return function(b, c, d, e) {
					b = a.getElement(b), b.removeEventListener(c, d, e)
				};
				if (window.detachEvent) return function(b, c, d) {
					b = a.getElement(b), b.detachEvent("on" + c, d)
				};
				throw new Error("No known event model.")
			}(),
			cancelEvent: function(b) {
				b = a.getEvent(b), a.cancelEvent = b.preventDefault ? function(a) {
					a.preventDefault()
				} : function(b) {
			...
			stopEvent: function(b) {
				b = a.getEvent(b), a.stopEvent = b.stopPropagation ? function(a) {
					a.stopPropagation()
				} : function(b) {
			...
			createAjaxRequest: function(b) {
				...
				if (c) a.createAjaxRequest = window.XMLHttpRequest ? function(a) {
			...
			makeAjaxRequest: function(b, c, d) {
				...
				if (!a.isFunction(c)) throw new Error("makeAjaxRequest requires a success callback");
				f.onreadystatechange = function() {
					if (4 == f.readyState) {
						f.onreadystatechange = function() {};
						var g = "http:" === e || "https:" === e ? 200 : 0;
						f.status === g ? c(f) : (a.console.log("AJAX request returned %d: %s", f.status, b), a.isFunction(d) && d(f))
					}
				};
				try {
					...
					i && "undefined" != typeof g.number && -2147024891 == g.number && (h += "\nSee http://msdn.microsoft.com/en-us/library/ms537505(v=vs.85).aspx#xdomain"), a.console.log("%s while making AJAX request: %s", g.name, h), f.onreadystatechange = function() {}, a.isFunction(d) && d(f, g)
				}
			},
			jsonp: function(b) {
				var c, d = b.url,
					...
					i = b.param || "callback",
					j = b.callback;
				d = d.replace(/(\=)\?(&|$)|\?\?/i, h), d += (/\?/.test(d) ? "&" : "?") + i + "=" + f, window[f] = function(b) {
					if (g) window[f] = g;
					else try {
						delete window[f]
					} catch (c) {}
					j && a.isFunction(j) && j(b)
				}, c = document.createElement("script"), (void 0 !== b.async || !1 !== b.async) && (c.async = "async"), b.scriptCharset && (c.charset = b.scriptCharset), c.src = d, c.onload = c.onreadystatechange = function(a, b) {
					(b || !c.readyState || /loaded|complete/.test(c.readyState)) && (c.onload = c.onreadystatechange = null, e && c.parentNode && e.removeChild(c), c = void 0)
			...
			parseXml: function(b) {
				if (window.DOMParser) a.parseXml = function(a) {
					var b, c = null;
		...
		var c = {
			...
			d = {};
		! function() {
			var b, c = (navigator.appName, navigator.appVersion),
				e = navigator.userAgent;
			switch (navigator.appName) {
				case "Microsoft Internet Explorer":
					window.attachEvent && window.ActiveXObject && (a.Browser.vendor = a.BROWSERS.IE, a.Browser.version = parseFloat(e.substring(e.indexOf("MSIE") + 5, e.indexOf(";", e.indexOf("MSIE")))));
					break;
				case "Netscape":
					window.addEventListener && (e.indexOf("Firefox") >= 0 ? (a.Browser.vendor = a.BROWSERS.FIREFOX, a.Browser.version = parseFloat(e.substring(e.indexOf("Firefox") + 8))) : e.indexOf("Safari") >= 0 ? (a.Browser.vendor = e.indexOf("Chrome") >= 0 ? a.BROWSERS.CHROME : a.BROWSERS.SAFARI, a.Browser.version = parseFloat(e.substring(e.substring(0, e.indexOf("Safari")).lastIndexOf("/") + 1, e.indexOf("Safari")))) : (b = new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})"), null !== b.exec(e) && (a.Browser.vendor = a.BROWSERS.IE, a.Browser.version = parseFloat(RegExp.$1))));
					break;
				case "Opera":
					a.Browser.vendor = a.BROWSERS.OPERA, a.Browser.version = parseFloat(c)
			}
			var f, g, h, i = window.location.search.substring(1),
				j = i.split("&");
			for (h = 0; h < j.length; h++) f = j[h], g = f.indexOf("="), g > 0 && (d[f.substring(0, g)] = decodeURIComponent(f.substring(g + 1)));
			a.Browser.alpha = !(a.Browser.vendor == a.BROWSERS.IE && a.Browser.version < 9 || a.Browser.vendor == a.BROWSERS.CHROME && a.Browser.version < 2), a.Browser.opacity = !(a.Browser.vendor == a.BROWSERS.IE && a.Browser.version < 9)
		}();
		var e = function() {};
		a.console = window.console || {
			...
			function(b) {
				...
				if (c && d) a.requestAnimationFrame = function() {
					...
					a.requestAnimationFrame = function(b) {
						return f.push([++h, b]), e || (e = setInterval(function() {
							if (f.length) {
								var b = a.now(),
									c = g;
						...
						for (b = 0, c = f.length; c > b; b += 1)
							if (f[b][0] === a) return void f.splice(b, 1);
						for (b = 0, c = g.length; c > b; b += 1)
							if (g[b][0] === a) return void g.splice(b, 1)
					}
				}
			}(window), a._processDZIError = function(a) {
	...
	function(a) {
		a.EventSource = function() {
			...
			addHandler: function(b, c, d) {
				var e = this.events[b];
				e || (this.events[b] = e = []), c && a.isFunction(c) && (e[e.length] = {
					handler: c,
					userData: d || null
				})
			},
			...
			getHandler: function(a) {
				...
				return b && b.length ? (b = 1 === b.length ? [b[0]] : Array.apply(null, b), function(a, c) {
					var d, e = b.length;
					for (d = 0; e > d; d++) b[d] && (c.eventSource = a, c.userData = b[d].userData, b[d].handler(c))
				}) : null
			},
	...
	function(a) {
		function b(b) {
			...
			for (c = 0; e > c; c++) d.activePointersLists.pop()
		}
		...
		function f(b, c) {
			...
			f.captureCount++, 1 === f.captureCount && (a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9 ? b.element.setCapture(!0) : (d = e(b, a.MouseTracker.havePointerEvents ? "pointerevent" : c), a.addEvent(a.MouseTracker.captureElement, d.upName, d.upHandler, !0), a.addEvent(a.MouseTracker.captureElement, d.moveName, d.moveHandler, !0)))
		}

		function g(b, c) {
			var d, f = b.getActivePointersListByType(c);
			f.captureCount--, 0 === f.captureCount && (a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9 ? b.element.releaseCapture() : (d = e(b, a.MouseTracker.havePointerEvents ? "pointerevent" : c), a.removeEvent(a.MouseTracker.captureElement, d.moveName, d.moveHandler, !0), a.removeEvent(a.MouseTracker.captureElement, d.upName, d.upHandler, !0)))
		}
		...
		function u(b, c) {
			...
			d.deltaY = "mousewheel" == a.MouseTracker.wheelEventName ? -1 / a.DEFAULT_SETTINGS.pixelsPerWheelLine * c.wheelDelta : c.detail, v(b, d, c)
		}
		...
		function E(b, c) {
			...
			c = a.getEvent(c), d = {
				...
				currentPos: i(c),
				currentTime: a.now()
			}, ib(b, c, [d], D(c.button)) && (a.stopEvent(c), f(b, "mouse")), (b.clickHandler || b.dblClickHandler || b.pressHandler || b.dragHandler || b.dragEndHandler) && a.cancelEvent(c)
		}
		...
		function L(a, b, c) {
			var d, e = c.getLength(),
				f = [];
			for (d = 0; e > d; d++) f.push(c.getByIndex(d));
			f.length > 0 && (jb(a, b, f, 0), c.captureCount = 1, g(a, "touch"), hb(a, b, f))
		}
		...
		function M(b, c) {
			...
			for (d = a.now(), l.getLength() > c.touches.length - j && (a.console.warn("Tracked touch contact count doesn't match event.touches.length. Removing all tracked touch pointers."), L(b, c, l)), e = 0; j > e; e++) k.push({
				id: c.changedTouches[e].identifier,
				type: "touch",
				currentPos: i(c.changedTouches[e]),
				currentTime: d
			});
			for (gb(b, c, k), e = 0; e < nb.length; e++)
				if (nb[e] !== b && nb[e].isTracking() && w(nb[e].element, b.element)) {
					for (h = [], g = 0; j > g; g++) h.push({
			...
			ib(b, c, k, 0) && (a.stopEvent(c), f(b, "touch")), a.cancelEvent(c)
		}
		...
		function P(b, c) {
			var d, e, f, h, j = c.changedTouches.length,
				k = [];
			for (d = a.now(), e = 0; j > e; e++) k.push({
				id: c.changedTouches[e].identifier,
				type: "touch",
				currentPos: i(c.changedTouches[e]),
				currentTime: d
			});
			for (jb(b, c, k, 0) && g(b, "touch"), hb(b, c, k), e = 0; e < nb.length; e++)
				if (nb[e] !== b && nb[e].isTracking() && w(nb[e].element, b.element)) {
					for (h = [], f = 0; j > f; f++) h.push({
		...
		function S(b, c) {
			var d, e = c.changedTouches.length,
				f = [];
			for (d = 0; e > d; d++) f.push({
				id: c.changedTouches[d].identifier,
				type: "touch",
				currentPos: i(c.changedTouches[d]),
				currentTime: a.now()
			});
			kb(b, c, f), a.cancelEvent(c)
		}

		function T(a, b) {
			var c, d = b.changedTouches.length,
				e = [];
			for (c = 0; d > c; c++) e.push({
		...
		function Y(b, c) {
			...
			d = {
				...
				currentPos: i(c),
				currentTime: a.now()
			}, ib(b, c, [d], c.button) && (a.stopEvent(c), f(b, d.type)), (b.clickHandler || b.dblClickHandler || b.pressHandler || b.dragHandler || b.dragEndHandler || b.pinchHandler) && a.cancelEvent(c)
		}
		...
		function bb(b, c) {
			var d = b.getActivePointersListByType(h(c));
			d.getById(c.pointerId) && cb(b, c), a.stopEvent(c)
		}
		...
		function eb(a, b) {
			return b.hasOwnProperty("isPrimary") || (b.isPrimary = 0 === a.getLength() ? !0 : !1), b.speed = 0, b.direction = 0, b.contactPos = b.currentPos, b.contactTime = b.currentTime, b.lastPos = b.currentPos, b.lastTime = b.currentTime, a.add(b)
		}

		function fb(a, b) {
			var c, d;
			return a.getById(b.id) ? (c = a.removeById(b.id), b.hasOwnProperty("isPrimary") || (d = a.getPrimary(), d || (d = a.getByIndex(0), d && (d.isPrimary = !0)))) : c = a.getLength(), c
		}

		function gb(b, c, d) {
			var e, f, g, h, i = b.getActivePointersListByType(d[0].type),
				j = d.length;
			for (e = 0; j > e; e++) f = d[e], g = i.getById(f.id), g ? (g.insideElement = !0, g.lastPos = g.currentPos, g.lastTime = g.currentTime, g.currentPos = f.currentPos, g.currentTime = f.currentTime, f = g) : (f.captured = !1, f.insideElementPressed = !1, f.insideElement = !0, eb(i, f)), b.enterHandler && (h = b.enterHandler({
				eventSource: b,
				pointerType: f.type,
		...
		function hb(b, c, d) {
			var e, f, g, h, i = (ob[b.hash], b.getActivePointersListByType(d[0].type)),
				j = d.length;
			for (e = 0; j > e; e++) f = d[e], g = i.getById(f.id), g && (g.captured ? (g.insideElement = !1, g.lastPos = g.currentPos, g.lastTime = g.currentTime, g.currentPos = f.currentPos, g.currentTime = f.currentTime) : fb(i, g), f = g), b.exitHandler && (h = b.exitHandler({
				eventSource: b,
				pointerType: f.type,
				position: k(f.currentPos, b.element),
				buttons: i.buttons,
		...
		function ib(b, c, d, e) {
			var f, g, h, i, j = ob[b.hash],
				m = b.getActivePointersListByType(d[0].type),
				n = d.length;
			if ("undefined" != typeof c.buttons ? m.buttons = c.buttons : a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9 ? 0 === e ? m.buttons += 1 : 1 === e ? m.buttons += 4 : 2 === e ? m.buttons += 2 : 3 === e ? m.buttons += 8 : 4 === e ? m.buttons += 16 : 5 === e && (m.buttons += 32) : 0 === e ? m.buttons |= 1 : 1 === e ? m.buttons |= 4 : 2 === e ? m.buttons |= 2 : 3 === e ? m.buttons |= 8 : 4 === e ? m.buttons |= 16 : 5 === e && (m.buttons |= 32), 0 !== e) return b.nonPrimaryPressHandler && (f = b.nonPrimaryPressHandler({
				eventSource: b,
		...
		function jb(b, c, d, e) {
			var f, g, h, i, j, m, n, o = ob[b.hash],
				p = b.getActivePointersListByType(d[0].type),
				q = d.length,
				r = !1,
				s = !1;
			if ("undefined" != typeof c.buttons ? p.buttons = c.buttons : a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9 ? 0 === e ? p.buttons -= 1 : 1 === e ? p.buttons -= 4 : 2 === e ? p.buttons -= 2 : 3 === e ? p.buttons -= 8 : 4 === e ? p.buttons -= 16 : 5 === e && (p.buttons -= 32) : 0 === e ? p.buttons ^= -2 : 1 === e ? p.buttons ^= -5 : 2 === e ? p.buttons ^= -3 : 3 === e ? p.buttons ^= -9 : 4 === e ? p.buttons ^= -17 : 5 === e && (p.buttons ^= -33), 0 !== e) return b.nonPrimaryReleaseHandler && (f = b.nonPrimaryReleaseHandler({
				eventSource: b,
				pointerType: d[0].type,
				position: k(d[0].currentPos, b.element),
				button: e,
			...
			for (i = 0; q > i; i++) j = d[i], m = p.getById(j.id), m && (m.captured && (m.captured = !1, r = !0, s = !0), m.lastPos = m.currentPos, m.lastTime = m.currentTime, m.currentPos = j.currentPos, m.currentTime = j.currentTime, m.insideElement || fb(p, m), g = m.currentPos, h = m.currentTime, s ? (p.contacts--, (b.dragHandler || b.dragEndHandler || b.pinchHandler) && a.MouseTracker.gesturePointVelocityTracker.removePoint(b, m), 0 === p.contacts ? (b.releaseHandler && (f = b.releaseHandler({
				eventSource: b,
				pointerType: m.type,
		...
		a.MouseTracker = function(b) {
			...
			destroy: function() {
				var a;
				for (d(this), this.element = null, a = 0; a < nb.length; a++)
					if (nb[a] === this) {
						nb.splice(a, 1);
						break
					}
				ob[this.hash] = null, delete ob[this.hash]
			},
			isTracking: function() {
			...
			getActivePointerCount: function() {
				var a, b = ob[this.hash],
					c = b.activePointersLists.length,
					d = 0;
				for (a = 0; c > a; a++) d += b.activePointersLists[a].getLength();
				return d
			},
			...
			var b = [],
				...
				f = function() {
					var c, e, f, g, h, i, j = b.length,
						k = a.now();
					for (g = k - d, d = k, c = 0; j > c; c++) e = b[c], f = e.gPoint, f.direction = Math.atan2(f.currentPos.y - e.lastPos.y, f.currentPos.x - e.lastPos.x), h = e.lastPos.distanceTo(f.currentPos), e.lastPos = f.currentPos, i = 1e3 * h / (g + 1), f.speed = .75 * i + .25 * f.speed
				},
				g = function(g, h) {
					var i = e(g, h);
					b.push({
			...
			getPrimary: function() {
				...
				for (a = 0; b > a; a++)
					if (this._gPoints[a].isPrimary) return this._gPoints[a];
				return null
			}
		}
	}(OpenSeadragon),
	...
	function($) {
		function _getSafeElemSize(a) {
			return a = $.getElement(a), new $.Point(0 === a.clientWidth ? 1 : a.clientWidth, 0 === a.clientHeight ? 1 : a.clientHeight)
		}

		function getTileSourceImplementation(viewer, tileSource, successCallback, failCallback) {
			var _this = viewer;
			"string" == $.type(tileSource) && (tileSource.match(/\s*<.*/) ? tileSource = $.parseXml(tileSource) : tileSource.match(/\s*[\{\[].*/) && (tileSource = eval("(" + tileSource + ")"))), setTimeout(function() {
				if ("string" == $.type(tileSource)) tileSource = new $.TileSource(tileSource, function(a) {
					...
					if ($.isFunction(tileSource.getTileUrl)) {
						...
						a.getTileUrl = tileSource.getTileUrl, successCallback(a)
					} else {
						var b = $.TileSource.determineType(_this, tileSource);
						if (!b) return void failCallback({
		...
		function openTileSource(a, b) {
			var c, d = a;
			return d.source && d.close(), THIS[d.hash].prevContainerSize = _getSafeElemSize(d.container), d.collectionMode ? (d.source = new $.TileSourceCollection({
				...
				viewer: d,
				degrees: d.degrees
			})) : (b && (d.source = b), d.viewport = d.viewport ? d.viewport : new $.Viewport({
				containerSize: THIS[d.hash].prevContainerSize,
				contentSize: d.source.dimensions,
				springStiffness: d.springStiffness,
				animationTime: d.animationTime,
			...
			})), d.preserveViewport && d.viewport.resetContentSize(d.source.dimensions), d.preserveOverlays && (d.overlays = d.currentOverlays), d.source.overlays = d.source.overlays || [], d.drawer = new $.Drawer({
				viewer: d,
				source: d.source,
				viewport: d.viewport,
			...
			}), d.drawers = [d.drawer], d.drawer.canRotate() || (d.rotateLeft && (c = d.buttons.buttons.indexOf(d.rotateLeft), d.buttons.buttons.splice(c, 1), d.buttons.element.removeChild(d.rotateLeft.element)), d.rotateRight && (c = d.buttons.buttons.indexOf(d.rotateRight), d.buttons.buttons.splice(c, 1), d.buttons.element.removeChild(d.rotateRight.element))), d.showNavigator && !d.collectionMode && (d.navigator ? d.navigator.open(b) : d.navigator = new $.Navigator({
				id: d.navigatorId,
				...
				prefixUrl: d.prefixUrl,
				viewer: d
			})), THIS[d.hash].animating = !1, THIS[d.hash].forceRedraw = !0, d._updateRequestId = scheduleUpdate(d, updateMulti), VIEWERS[d.hash] = d, loadOverlays(d), d.raiseEvent("open", {
				source: b
			}), d
		}
		...
		function loadOverlays(a) {
			a.currentOverlays = [];
			for (var b = 0; b < a.overlays.length; b++) a.currentOverlays[b] = getOverlayObject(a, a.overlays[b]);
			for (var c = 0; c < a.source.overlays.length; c++) a.currentOverlays[b + c] = getOverlayObject(a, a.source.overlays[c])
		}

		function getOverlayObject(a, b) {
			if (b instanceof $.Overlay) return b;
			var c = null;
			if (b.element) c = $.getElement(b.element);
			else {
				var d = b.id ? b.id : "openseadragon-overlay-" + Math.floor(1e7 * Math.random());
				c = $.getElement(b.id), c || (c = document.createElement("a"), c.href = "#/overlay/" + d), c.id = d, $.addClass(c, b.className ? b.className : "openseadragon-overlay")
			}
			var e = b.location;
			...
			var f = b.placement;
			return f && "string" === $.type(f) && (f = $.OverlayPlacement[b.placement.toUpperCase()]), new $.Overlay({
				element: c,
				location: e,
				placement: f,
				onDraw: b.onDraw,
		...
		function drawOverlays(a, b, c) {
			var d, e = b.length;
			for (d = 0; e > d; d++) b[d].drawHTML(c, a)
		}
		...
		function beginControlsAutoHide(a) {
			a.autoHideControls && (a.controlsShouldFade = !0, a.controlsFadeBeginTime = $.now() + a.controlsFadeDelay, window.setTimeout(function() {
		...
		function updateControlsFade(a) {
			...
			if (a.controlsShouldFade) {
				for (b = $.now(), c = b - a.controlsFadeBeginTime, d = 1 - c / a.controlsFadeLength, d = Math.min(1, d), d = Math.max(0, d), e = a.controls.length - 1; e >= 0; e--) a.controls[e].autoFade && a.controls[e].setOpacity(d);
		...
		function onCanvasKeyDown(a) {
			...
			switch (a.keyCode) {
				case 38:
					return a.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(new $.Point(0, -.05)), this.viewport.applyConstraints(), !1;
				case 40:
					return a.shift ? this.viewport.zoomBy(.9) : this.viewport.panBy(new $.Point(0, .05)), this.viewport.applyConstraints(), !1;
				case 37:
					return this.viewport.panBy(new $.Point(-.05, 0)), this.viewport.applyConstraints(), !1;
				case 39:
					return this.viewport.panBy(new $.Point(.05, 0)), this.viewport.applyConstraints(), !1;
				default:
					return !0
		...
		function onCanvasClick(a) {
			...
			c || this.canvas.focus(), !a.preventDefaultAction && this.viewport && a.quick && (b = this.gestureSettingsByDeviceType(a.pointerType), b.clickToZoom && (this.viewport.zoomBy(a.shift ? 1 / this.zoomPerClick : this.zoomPerClick, this.viewport.pointFromPixel(a.position, !0)), this.viewport.applyConstraints())), this.raiseEvent("canvas-click", {
		...
		function onCanvasDblClick(a) {
			var b;
			!a.preventDefaultAction && this.viewport && (b = this.gestureSettingsByDeviceType(a.pointerType), b.dblClickToZoom && (this.viewport.zoomBy(a.shift ? 1 / this.zoomPerClick : this.zoomPerClick, this.viewport.pointFromPixel(a.position, !0)), this.viewport.applyConstraints())), this.raiseEvent("canvas-double-click", {
				tracker: a.eventSource,
				position: a.position,
				shift: a.shift,
				originalEvent: a.originalEvent
		...
		function onCanvasDragEnd(a) {
			...
			if (!a.preventDefaultAction && this.viewport) {
				if (b = this.gestureSettingsByDeviceType(a.pointerType), b.flickEnabled && a.speed >= b.flickMinSpeed) {
					...
					this.panHorizontal || (f.x = e.x), this.panVertical || (f.y = e.y), this.viewport.panTo(f, !1)
				}
		...
		function onCanvasScroll(a) {
			var b, c;
			return !a.preventDefaultAction && this.viewport && (b = this.gestureSettingsByDeviceType(a.pointerType), b.scrollToZoom && (c = Math.pow(this.zoomPerScroll, a.scroll), this.viewport.zoomBy(c, this.viewport.pointFromPixel(a.position, !0)), this.viewport.applyConstraints())), this.raiseEvent("canvas-scroll", {
				tracker: a.eventSource,
				position: a.position,
				scroll: a.scroll,
				shift: a.shift,
		...
		function onContainerEnter(a) {
			THIS[this.hash].mouseInside = !0, abortControlsAutoHide(this), this.raiseEvent("container-enter", {
				tracker: a.eventSource,
				position: a.position,
				buttons: a.buttons,
				pointers: a.pointers,
		...
		function onContainerExit(a) {
			a.pointers < 1 && (THIS[this.hash].mouseInside = !1, THIS[this.hash].animating || beginControlsAutoHide(this)), this.raiseEvent("container-exit", {
				tracker: a.eventSource,
				position: a.position,
				buttons: a.buttons,
				pointers: a.pointers,
		...
		function updateDrawers(a) {
			for (var b = 0; b < a.drawers.length; b++) a.drawers[b].update()
		}

		function drawersNeedUpdate(a) {
			for (var b = 0; b < a.drawers.length; b++)
				if (a.drawers[b].needsUpdate()) return !0;
			return !1
		}
		...
		function beginZoomingIn() {
			THIS[this.hash].lastZoomTime = $.now(), THIS[this.hash].zoomFactor = this.zoomPerSecond, THIS[this.hash].zooming = !0, scheduleZoom(this)
		}

		function beginZoomingOut() {
			THIS[this.hash].lastZoomTime = $.now(), THIS[this.hash].zoomFactor = 1 / this.zoomPerSecond, THIS[this.hash].zooming = !0, scheduleZoom(this)
		}
		...
		function doZoom() {
			var a, b, c;
			THIS[this.hash].zooming && this.viewport && (a = $.now(), b = a - THIS[this.hash].lastZoomTime, c = Math.pow(THIS[this.hash].zoomFactor, b / 1e3), this.viewport.zoomBy(c), this.viewport.applyConstraints(), THIS[this.hash].lastZoomTime = a, scheduleZoom(this))
		}

		function doSingleZoomIn() {
			this.viewport && (THIS[this.hash].zooming = !1, this.viewport.zoomBy(this.zoomPerClick / 1), this.viewport.applyConstraints())
		}

		function doSingleZoomOut() {
			this.viewport && (THIS[this.hash].zooming = !1, this.viewport.zoomBy(1 / this.zoomPerClick), this.viewport.applyConstraints())
		}
		...
		function onFullScreen() {
			this.isFullPage() && !$.isFullScreen() ? this.setFullPage(!1) : this.setFullScreen(!this.isFullPage()), this.buttons && this.buttons.emulateExit(), this.fullPageButton.element.focus(), this.viewport && this.viewport.applyConstraints()
		}

		function onRotateLeft() {
			if (this.viewport) {
				var a = this.viewport.getRotation();
				0 === a ? a = 270 : a -= 90, this.viewport.setRotation(a)
			}
		}
		...
		function onRotateRight() {
			if (this.viewport) {
				var a = this.viewport.getRotation();
				270 === a ? a = 0 : a += 90, this.viewport.setRotation(a)
			}
		}

		function onPrevious() {
			var a = THIS[this.hash].sequence - 1;
			this.navPrevNextWrap && 0 > a && (a += this.tileSources.length), this.goToPage(a)
		}
		...
		$.Viewer = function(a) {
			...
			if ($.isPlainObject(a) || (a = {
				...
				}), a.config && ($.extend(!0, a, a.config), delete a.config), $.extend(!0, this, {
					id: a.id,
					hash: a.hash || a.id,
					element: null,
					container: null,
					...
					buttons: null,
					profiler: null
				}, $.DEFAULT_SETTINGS, a), "undefined" == typeof this.hash) throw new Error("A hash must be defined, either by specifying options.id or options.hash.");
			"undefined" != typeof THIS[this.hash] && $.console.warn("Hash " + this.hash + " has already been used."), THIS[this.hash] = {
			...
			for (this.xmlPath && (this.tileSources = [this.xmlPath]), this.tileSources && ($.isArray(this.tileSources) ? (this.tileSources.length > 1 && (THIS[this.hash].sequenced = !0), this.initialPage > this.tileSources.length - 1 && (this.initialPage = this.tileSources.length - 1), e = this.tileSources[this.initialPage], THIS[this.hash].sequence = this.initialPage) : e = this.tileSources), this.element = this.element || document.getElementById(this.id), this.canvas = $.makeNeutralElement("div"), this.drawersContainer = $.makeNeutralElement("div"), this.overlaysContainer = $.makeNeutralElement("div"), this.canvas.className = "openseadragon-canvas", function(a) {
				...
				})), this.bindStandardControls(), this.bindSequenceControls(), e && (this.open(e), this.tileSources.length > 1 && this._updateSequenceButtons(this.initialPage)), b = 0; b < this.customControls.length; b++) this.addControl(this.customControls[b].id, {
			...
			open: function(a) {
				var b = this;
				return b._hideMessage(), getTileSourceImplementation(b, a, function(a) {
					openTileSource(b, a)
				}, function(a) {
			...
			close: function() {
				return THIS[this.hash] ? (null !== this._updateRequestId && ($.cancelAnimationFrame(this._updateRequestId), this._updateRequestId = null), this.navigator && this.navigator.close(), this.preserveOverlays || (this.clearOverlays(), this.overlaysContainer.innerHTML = ""), this.drawersContainer.innerHTML = "", this.drawer && this.drawer.destroy(), this.source = null, this.drawer = null, this.drawers = [], this.viewport = this.preserveViewport ? this.viewport : null, VIEWERS[this.hash] = null, delete VIEWERS[this.hash], this.raiseEvent("close"), this) : this
			},
			destroy: function() {
				if (this.close(), this.removeAllHandlers(), this.element)
					for (; this.element.firstChild;) this.element.removeChild(this.element.firstChild);
				this.innerTracker && this.innerTracker.destroy(), this.outerTracker && this.outerTracker.destroy(), THIS[this.hash] = null, delete THIS[this.hash], this.canvas = null, this.container = null, this.element = null
			},
			isMouseNavEnabled: function() {
				return this.innerTracker.isTracking()
			},
			setMouseNavEnabled: function(a) {
				return this.innerTracker.setTracking(a), this.raiseEvent("mouse-enabled", {
					enabled: a
				}), this
			},
			areControlsEnabled: function() {
			...
			setControlsEnabled: function(a) {
				return a ? abortControlsAutoHide(this) : beginControlsAutoHide(this), this.raiseEvent("controls-enabled", {
					enabled: a
				}), this
			},
			isFullPage: function() {
			...
			setFullScreen: function(a) {
				var b = this;
				if (!$.supportsFullScreen) return this.setFullPage(a);
				if ($.isFullScreen() === a) return this;
				var c = {
					fullScreen: a,
					preventDefaultAction: !1
				};
				...
				if (a) {
					...
					var d = function() {
						var a = $.isFullScreen();
						a || ($.removeEvent(document, $.fullScreenEventName, d), $.removeEvent(document, $.fullScreenErrorEventName, d), b.setFullPage(!1), b.isFullPage() && (b.element.style.width = b.fullPageStyleWidth, b.element.style.height = b.fullPageStyleHeight)), b.navigator && b.viewport && b.navigator.update(b.viewport), b.raiseEvent("full-screen", {
							fullScreen: a
						})
					};
					$.addEvent(document, $.fullScreenEventName, d), $.addEvent(document, $.fullScreenErrorEventName, d), $.requestFullScreen(document.body)
				} else $.exitFullScreen();
				return this
			},
			isVisible: function() {
			...
			setVisible: function(a) {
				return this.container.style.visibility = a ? "" : "hidden", this.raiseEvent("visible", {
					visible: a
				}), this
			},
			addLayer: function(a) {
				...
				var c = this,
					d = a.tileSource;
				if (!this.isOpen()) throw new Error("An image must be loaded before adding layers.");
				if (!d) throw new Error("No tile source provided as new layer.");
				if (this.collectionMode) throw new Error("Layers not supported in collection mode.");
				return getTileSourceImplementation(this, d, function(d) {
					if (d instanceof Array) return void b({
					...
					for (var e = 0; e < c.drawers.length; e++) {
						var f = c.drawers[e].source.aspectRatio,
							g = f - d.aspectRatio;
						if (Math.abs(g) > c.layersAspectRatioEpsilon) return void b({
					...
					c.drawers.push(h), void 0 !== a.level && c.setLayerLevel(h, a.level), THIS[c.hash].forceRedraw = !0, c.raiseEvent("add-layer", {
						options: a,
						drawer: h
					})
				}, function(c) {
			...
			getLayerAtLevel: function(a) {
				if (a >= this.drawers.length) throw new Error("Level bigger than number of layers.");
			...
			setLayerLevel: function(a, b) {
				...
				if (b >= this.drawers.length) throw new Error("Level bigger than number of layers.");
				if (b === c || -1 === c) return this;
				if (0 === b || 0 === c) {
					if (THIS[this.hash].sequenced) throw new Error("Cannot reassign base level when in sequence mode.");
					this.drawer = 0 === b ? a : this.getLayerAtLevel(b), this.source = this.drawer.source
				}
				if (this.drawers.splice(c, 1), this.drawers.splice(b, 0, a), this.drawersContainer.removeChild(a.canvas), 0 === b) {
			...
			removeLayer: function(a) {
				...
				if (-1 === b) return this;
				if (0 === b) {
					if (THIS[this.hash].sequenced) throw new Error("Cannot remove base layer when in sequence mode.");
					if (1 === this.drawers.length) return this.close(), this;
					this.drawer = this.drawers[1]
				}
				return this.drawers.splice(b, 1), this.drawersContainer.removeChild(a.canvas), this.raiseEvent("remove-layer", {
					drawer: a
				}), this
			},
			forceRedraw: function() {
				return THIS[this.hash].forceRedraw = !0, this
			},
			bindSequenceControls: function() {
				var a = $.delegate(this, onFocus),
					...
					e = this.navImages,
					f = !0;
				return this.showSequenceControl && THIS[this.hash].sequenced && ((this.previousButton || this.nextButton) && (f = !1), this.previousButton = new $.Button({
					...
					onFocus: a,
					onBlur: b
				}), this.navPrevNextWrap || this.previousButton.disable(), f && (this.paging = new $.ButtonGroup({
			...
			bindStandardControls: function() {
				var a = $.delegate(this, beginZoomingIn),
					...
					m = [],
					n = !0;
				return this.showNavigationControl && ((this.zoomInButton || this.zoomOutButton || this.homeButton || this.fullPageButton || this.rotateLeftButton || this.rotateRightButton) && (n = !1), this.showZoomControl && (m.push(this.zoomInButton = new $.Button({
					...
					clickTimeThreshold: this.clickTimeThreshold,
					clickDistThreshold: this.clickDistThreshold
				}), this.navControl = this.buttons.element, this.addHandler("open", $.delegate(this, lightUp)), this.toolbar ? this.toolbar.addControl(this.navControl, {
			...
			goToPage: function(a) {
				return a >= 0 && a < this.tileSources.length && (this.raiseEvent("page", {
					page: a
				}), THIS[this.hash].sequence = a, this._updateSequenceButtons(a), this.open(this.tileSources[a]), this.referenceStrip && this.referenceStrip.setFocus(a)), this
			},
			addOverlay: function(a, b, c, d) {
				...
				return e = $.isPlainObject(a) ? a : {
					...
					placement: c,
					onDraw: d
				}, a = $.getElement(e.element), getOverlayIndex(this.currentOverlays, a) >= 0 ? this : (this.currentOverlays.push(getOverlayObject(this, e)), THIS[this.hash].forceRedraw = !0, this.raiseEvent("add-overlay", {
					element: a,
					location: e.location,
			...
			updateOverlay: function(a, b, c) {
				var d;
				return a = $.getElement(a), d = getOverlayIndex(this.currentOverlays, a), d >= 0 && (this.currentOverlays[d].update(b, c), THIS[this.hash].forceRedraw = !0, this.raiseEvent("update-overlay", {
					element: a,
					location: b,
					placement: c
				})), this
			...
			removeOverlay: function(a) {
				var b;
				return a = $.getElement(a), b = getOverlayIndex(this.currentOverlays, a), b >= 0 && (this.currentOverlays[b].destroy(), this.currentOverlays.splice(b, 1), THIS[this.hash].forceRedraw = !0, this.raiseEvent("remove-overlay", {
					element: a
				})), this
			},
			clearOverlays: function() {
				for (; this.currentOverlays.length > 0;) this.currentOverlays.pop().destroy();
				return THIS[this.hash].forceRedraw = !0, this.raiseEvent("clear-overlay", {}), this
			},
			_updateSequenceButtons: function(a) {
				this.nextButton && (this.tileSources.length - 1 === a ? this.navPrevNextWrap || this.nextButton.disable() : this.nextButton.enable()), this.previousButton && (a > 0 ? this.previousButton.enable() : this.navPrevNextWrap || this.previousButton.disable())
			},
			_showMessage: function(a) {
				this._hideMessage();
				var b = $.makeNeutralElement("div");
				b.appendChild(document.createTextNode(a)), this.messageDiv = $.makeCenteredNode(b), $.addClass(this.messageDiv, "openseadragon-message"), this.container.appendChild(this.messageDiv)
			},
	...
	function(a) {
		function b(a) {
			a.quick && this.viewer.viewport && (this.viewer.viewport.panTo(this.viewport.pointFromPixel(a.position).rotate(-this.viewer.viewport.degrees, this.viewer.viewport.getHomeBounds().getCenter())), this.viewer.viewport.applyConstraints())
		}

		function c(a) {
			this.viewer.viewport && (this.panHorizontal || (a.delta.x = 0), this.panVertical || (a.delta.y = 0), this.viewer.viewport.panBy(this.viewport.deltaPointsFromPixels(a.delta)))
		}
		...
		function f(a, b) {
			a.style.webkitTransform = "rotate(" + b + "deg)", a.style.mozTransform = "rotate(" + b + "deg)", a.style.msTransform = "rotate(" + b + "deg)", a.style.oTransform = "rotate(" + b + "deg)", a.style.transform = "rotate(" + b + "deg)"
		}
		a.Navigator = function(g) {
			var h, i, j = g.viewer,
				k = this;
			g.id ? (this.element = document.getElementById(g.id), g.controlOptions = {
				...
				}), g.minPixelRatio = this.minPixelRatio = j.minPixelRatio, a.setElementTouchActionNone(this.element), this.borderWidth = 2, this.fudge = new a.Point(1, 1), this.totalBorderWidths = new a.Point(2 * this.borderWidth, 2 * this.borderWidth).minus(this.fudge), g.controlOptions.anchor != a.ControlAnchor.NONE && ! function(a, b) {
					a.margin = "0px", a.border = b + "px solid #555", a.padding = "0px", a.background = "#000", a.opacity = .8, a.overflow = "hidden"
				}(this.element.style, this.borderWidth), this.displayRegion = a.makeNeutralElement("div"), this.displayRegion.id = this.element.id + "-displayregion", this.displayRegion.className = "displayregion",
				function(a, b) {
					a.position = "relative", a.top = "0px", a.left = "0px", a.fontSize = "0px", a.overflow = "hidden", a.border = b + "px solid #900", a.margin = "0px", a.padding = "0px", a.background = "transparent", a["float"] = "left", a.cssFloat = "left", a.styleFloat = "left", a.zIndex = 999999999, a.cursor = "default"
				}(this.displayRegion.style, this.borderWidth), this.displayRegionContainer = a.makeNeutralElement("div"), this.displayRegionContainer.id = this.element.id + "-displayregioncontainer", this.displayRegionContainer.className = "displayregioncontainer", this.displayRegionContainer.style.width = "100%", this.displayRegionContainer.style.height = "100%", j.addControl(this.element, g.controlOptions), g.controlOptions.anchor != a.ControlAnchor.ABSOLUTE && g.controlOptions.anchor != a.ControlAnchor.NONE && (g.width && g.height ? (this.element.style.height = "number" == typeof g.height ? g.height + "px" : g.height, this.element.style.width = "number" == typeof g.width ? g.width + "px" : g.width) : (h = a.getElementSize(j.element), this.element.style.height = Math.round(h.y * g.sizeRatio) + "px", this.element.style.width = Math.round(h.x * g.sizeRatio) + "px", this.oldViewerSize = h), i = a.getElementSize(this.element), this.elementArea = i.x * i.y), this.oldContainerSize = new a.Point(0, 0), a.Viewer.apply(this, [g]), this.displayRegionContainer.appendChild(this.displayRegion), this.element.getElementsByTagName("div")[0].appendChild(this.displayRegionContainer), g.navigatorRotate && g.viewer.addHandler("rotate", function(a) {
					f(k.displayRegionContainer, a.degrees), f(k.displayRegion, -a.degrees), k.viewport.setRotation(a.degrees)
			...
			updateSize: function() {
				if (this.viewport) {
					...
					if (!b.equals(this.oldContainerSize)) {
						...
						this.viewport.fitBounds(h, !0), this.oldContainerSize = b, this.drawer.update()
					}
				}
			},
			update: function(b) {
				var c, d, e, f, g, h;
				c = a.getElementSize(this.viewer.element), c.equals(this.oldViewerSize) || (this.oldViewerSize = c, this.maintainSizeRatio ? (d = c.x * this.sizeRatio, e = c.y * this.sizeRatio) : (d = Math.sqrt(this.elementArea * (c.x / c.y)), e = this.elementArea / d), this.element.style.width = Math.round(d) + "px", this.element.style.height = Math.round(e) + "px", this.updateSize()), b && this.viewport && (f = b.getBounds(!0), g = this.viewport.pixelFromPoint(f.getTopLeft(), !1), h = this.viewport.pixelFromPoint(f.getBottomRight(), !1).minus(this.totalBorderWidths), function(a) {
					a.top = Math.round(g.y) + "px", a.left = Math.round(g.x) + "px";
					var b = Math.abs(g.x - h.x),
						c = Math.abs(g.y - h.y);
					a.width = Math.round(Math.max(b, 0)) + "px", a.height = Math.round(Math.max(c, 0)) + "px"
				}(this.displayRegion.style))
			},
			open: function(b) {
				this.updateSize();
				...
				return this.minPixelRatio = d > c.x || d > c.y ? Math.min(c.x, c.y) / d : this.viewer.minPixelRatio, a.Viewer.prototype.open.apply(this, [b])
			}
		})
	}(OpenSeadragon),
	function(a) {
		...
		a.extend(a, {
			getString: function(c) {
				...
				return f = h[e[d]], "string" != typeof f && (a.console.debug("Untranslated source string:", c), f = ""), f.replace(/\{\d+\}/g, function(a) {
	...
	function($) {
		function processResponse(xhr) {
			...
			if (200 !== xhr.status && 0 !== xhr.status) throw status = xhr.status, statusText = 404 == status ? "Not Found" : xhr.statusText, new Error($.getString("Errors.Status", status, statusText));
		...
		$.TileSource = function(a) {
			...
			getClosestLevel: function(a) {
				var b, c, d;
				for (b = this.minLevel; b < this.maxLevel && (d = this.getNumTiles(b), c = Math.floor(Math.max(a.x, a.y) / this.getTileSize(b)), !(Math.max(d.x, d.y) + 1 >= c)); b++);
			...
			getTileBounds: function(a, b, c) {
				var d = this.dimensions.times(this.getLevelScale(a)),
					...
					j = 1 / d.x;
				return h = Math.min(h, d.x - f), i = Math.min(i, d.y - g), new $.Rect(f * j, g * j, h * j, i * j)
			},
			getImageInfo: function(a) {
				var b, c, d, e, f, g, h, i = this;
				a && (f = a.split("/"), g = f[f.length - 1], h = g.lastIndexOf("."), h > -1 && (f[f.length - 1] = g.slice(0, h))), c = function(b) {
					"string" == typeof b && (b = $.parseXml(b));
					var c = $.TileSource.determineType(i, b, a);
					return c ? (e = c.prototype.configure.apply(i, [b, a]), d = new c(e), i.ready = !0, void i.raiseEvent("ready", {
						tileSource: d
					})) : void i.raiseEvent("open-failed", {
						message: "Unable to load TileSource",
						source: a
					})
				}, a.match(/\.js$/) ? (b = a.split("/").pop().replace(".js", ""), $.jsonp({
					url: a,
					async: !1,
					callbackName: b,
					callback: c
					...
					try {
						...
						var f;
						f = "undefined" != typeof c && c.toString ? c.toString() : "Unknown error", d = f + " attempting to load TileSource"
					}
		...
		}, $.extend(!0, $.TileSource.prototype, $.EventSource.prototype), $.TileSource.determineType = function(a, b, c) {
			var d;
			for (d in OpenSeadragon)
				if (d.match(/.+TileSource$/) && $.isFunction(OpenSeadragon[d]) && $.isFunction(OpenSeadragon[d].prototype.supports) && OpenSeadragon[d].prototype.supports.call(a, b, c)) return OpenSeadragon[d];
	...
	function(a) {
		...
		a.DziTileSource = function(b) {
			...
			if (f = a.isPlainObject(b) ? b : {
				...
				}, this._levelRects = {}, this.tilesUrl = f.tilesUrl, this.fileFormat = f.fileFormat, this.displayRects = f.displayRects, this.displayRects)
				for (c = this.displayRects.length - 1; c >= 0; c--)
					for (d = this.displayRects[c], e = d.minLevel; e <= d.maxLevel; e++) this._levelRects[e] || (this._levelRects[e] = []), this._levelRects[e].push(d);
			a.TileSource.apply(this, [f])
		}, a.extend(a.DziTileSource.prototype, a.TileSource.prototype, {
			supports: function(a) {
				var b;
				return a.Image ? b = a.Image.xmlns : a.documentElement && ("Image" == a.documentElement.localName || "Image" == a.documentElement.tagName) && (b = a.documentElement.namespaceURI), "http://schemas.microsoft.com/deepzoom/2008" == b || "http://schemas.microsoft.com/deepzoom/2009" == b
			},
			configure: function(d, e) {
				var f;
				return f = a.isPlainObject(d) ? c(this, d) : b(this, d), e && !f.tilesUrl && (f.tilesUrl = e.replace(/([^\/]+)\.(dzi|xml|js)(\?.*|$)/, "$1_files/"), f.queryParams = -1 != e.search(/\.(dzi|xml|js)\?/) ? e.match(/\?.*/) : ""), f
			},
			...
			tileExists: function(a, b, c) {
				...
				for (j = k.length - 1; j >= 0; j--)
					if (d = k[j], !(a < d.minLevel || a > d.maxLevel) && (e = this.getLevelScale(a), f = d.x * e, g = d.y * e, h = f + d.width * e, i = g + d.height * e, f = Math.floor(f / this.tileSize), g = Math.floor(g / this.tileSize), h = Math.ceil(h / this.tileSize), i = Math.ceil(i / this.tileSize), b >= f && h > b && c >= g && i > c)) return !0;
				return !1
			}
		})
	}(OpenSeadragon),
	function(a) {
		...
		function c(b, d, e) {
			var f, g;
			if (3 == b.nodeType && e) g = b.nodeValue.trim(), g.match(/^\d*$/) && (g = Number(g)), d[e] ? (a.isArray(d[e]) || (d[e] = [d[e]]), d[e].push(g)) : d[e] = g;
			else if (1 == b.nodeType)
				for (f = 0; f < b.childNodes.length; f++) c(b.childNodes[f], d, b.nodeName)
		}
		a.IIIFTileSource = function(b) {
			if (a.extend(!0, this, b), !(this.height && this.width && this["@id"])) throw new Error("IIIF required parameters not provided.");
			if (b.tileSizePerScaleFactor = {}, this.tile_width) b.tileSize = this.tile_width;
			else if (this.tile_height) b.tileSize = this.tile_height;
			else if (this.tiles)
				if (1 == this.tiles.length) b.tileSize = this.tiles[0].width, this.scale_factors = this.tiles[0].scaleFactors;
				else {
					this.scale_factors = [];
					for (var c = 0; c < this.tiles.length; c++)
						for (var d = 0; d < this.tiles[c].scaleFactors.length; d++) {
							var e = this.tiles[c].scaleFactors[d];
							this.scale_factors.push(e), b.tileSizePerScaleFactor[e] = this.tiles[c].width
						}
				}
			else {
				for (var f = Math.min(this.height, this.width), g = [256, 512, 1024], h = [], i = 0; i < g.length; i++) g[i] <= f && h.push(g[i]);
				b.tileSize = h.length > 0 ? Math.max.apply(null, h) : f, this.tile_width = b.tileSize, this.tile_height = b.tileSize
			}
			b.maxLevel || (b.maxLevel = this.scale_factors ? Math.floor(Math.pow(Math.max.apply(null, this.scale_factors), .5)) : Number(Math.ceil(Math.log(Math.max(this.width, this.height), 2)))), a.TileSource.apply(this, [b])
			...
			configure: function(c, d) {
				if (a.isPlainObject(c)) return c["@context"] ? c : (c["@context"] = "http://iiif.io/api/image/1.0/context.json", c["@id"] = d.replace("/info.json", ""), c);
				var e = b(c);
				return e["@context"] = "http://iiif.io/api/image/1.0/context.json", e["@id"] = d.replace("/info.xml", ""), e
			},
			getTileSize: function(a) {
				var b = Math.pow(2, this.maxLevel - a);
				return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[b] && (this.tileSize = this.tileSizePerScaleFactor[b]), this.tileSize
			},
			getTileUrl: function(a, b, c) {
				var d, e, f, g, h, i, j, k, l, m, n = "0",
					o = Math.pow(.5, this.maxLevel - a),
					p = Math.ceil(this.width * o),
					q = Math.ceil(this.height * o);
				return d = Math.ceil(this.getTileSize(a) / o), e = d, l = this["@context"].indexOf("/1.0/context.json") > -1 || this["@context"].indexOf("/1.1/context.json") > -1 || this["@context"].indexOf("/1/context.json") > -1 ? "native.jpg" : "default.jpg", p < this.tile_width && q < this.tile_height ? (k = p + ",", f = "full") : (g = b * d, h = c * e, i = Math.min(d, this.width - g), j = Math.min(e, this.height - h), k = Math.ceil(i * o) + ",", f = [g, h, i, j].join(",")), m = [this["@id"], f, k, n, l].join("/")
			}
		})
	}(OpenSeadragon),
	function(a) {
		a.OsmTileSource = function(b) {
			...
			c = a.isPlainObject(b) ? b : {
				...
				tileOverlap: arguments[3],
				tilesUrl: arguments[4]
			}, c.width && c.height || (c.width = 65572864, c.height = 65572864), c.tileSize || (c.tileSize = 256, c.tileOverlap = 0), c.tilesUrl || (c.tilesUrl = "http://tile.openstreetmap.org/"), c.minLevel = 8, a.TileSource.apply(this, [c])
	...
	function(a) {
		a.TmsTileSource = function(b) {
			...
			var d, e = 256 * Math.ceil(c.width / 256),
				f = 256 * Math.ceil(c.height / 256);
			d = e > f ? e / 256 : f / 256, c.maxLevel = Math.ceil(Math.log(d) / Math.log(2)) - 1, c.tileSize = 256, c.width = e, c.height = f, a.TileSource.apply(this, [c])
	...
	function(a) {
		function b(b) {
			var c, d, e = [];
			for (d = 0; d < b.length; d++) c = b[d], c.height && c.width && c.url && (c.url.toLowerCase().match(/^.*\.(png|jpg|jpeg|gif)$/) || c.mimetype && c.mimetype.toLowerCase().match(/^.*\/(png|jpg|jpeg|gif)$/)) ? e.push({
				url: c.url,
		...
		a.LegacyTileSource = function(c) {
			...
			getTileUrl: function(a) {
				var b = null;
				return this.levels.length > 0 && a >= this.minLevel && a <= this.maxLevel && (b = this.levels[a].url), b
			}
		})
	}(OpenSeadragon),
	function(a) {
		a.TileSourceCollection = function(b) {
			...
			var d = 0,
				...
				g = f >= c.rows ? f : c.rows;
			for ("horizontal" == c.layout ? (c.width = c.tileSize * f, c.height = c.tileSize * c.rows) : (c.height = c.tileSize * f, c.width = c.tileSize * c.rows), c.tileOverlap = -c.tileMargin, c.tilesPerRow = f; e < c.tileSize * g;) e = 2 * e, d++;
			...
			getTileBounds: function(b, c, d) {
				var e = this.dimensions.times(this.getLevelScale(b)),
					...
					j = 1 / e.x;
				return h = Math.min(h, e.x - f), i = Math.min(i, e.y - g), new a.Rect(f * j, g * j, h * j, i * j)
			},
			configure: function() {},
			getTileUrl: function() {
				return null
		...
		a.ButtonState = {
			...
			a.EventSource.call(this), a.extend(!0, this, {
				...
				enterHandler: function(b) {
					b.insideElementPressed ? (f(c, a.ButtonState.DOWN), c.raiseEvent("enter", {
						originalEvent: b.originalEvent
					})) : b.buttonDownAny || f(c, a.ButtonState.HOVER)
				},
				focusHandler: function(a) {
					this.enterHandler(a), c.raiseEvent("focus", {
						originalEvent: a.originalEvent
					})
				},
				exitHandler: function(b) {
					g(c, a.ButtonState.GROUP), b.insideElementPressed && c.raiseEvent("exit", {
						originalEvent: b.originalEvent
					})
				},
				blurHandler: function(a) {
					this.exitHandler(a), c.raiseEvent("blur", {
						originalEvent: a.originalEvent
					})
				},
				pressHandler: function(b) {
					f(c, a.ButtonState.DOWN), c.raiseEvent("press", {
						originalEvent: b.originalEvent
					})
				},
				releaseHandler: function(b) {
					b.insideElementPressed && b.insideElementReleased ? (g(c, a.ButtonState.HOVER), c.raiseEvent("release", {
						originalEvent: b.originalEvent
	...
	function(a) {
		a.ButtonGroup = function(b) {
			...
			var c, d = this.buttons.concat([]),
				e = this;
			if (this.element = b.element || a.makeNeutralElement("div"), !b.group)
				for (this.label = a.makeNeutralElement("label"), this.element.style.display = "inline-block", this.element.appendChild(this.label), c = 0; c < d.length; c++) this.element.appendChild(d[c].element);
			a.setElementTouchActionNone(this.element), this.tracker = new a.MouseTracker({
				...
				enterHandler: function() {
					var a;
					for (a = 0; a < e.buttons.length; a++) e.buttons[a].notifyGroupEnter()
				},
	...
	function(a) {
		a.Rect = function(a, b, c, d) {
			...
			rotate: function(b, c) {
				var d, e = this.width,
					f = this.height;
				if (b = (b + 360) % 360, b % 90 !== 0) throw new Error("Currently only 0, 90, 180, and 270 degrees are supported.");
				if (0 === b) return new a.Rect(this.x, this.y, this.width, this.height);
	...
	function(a) {
		...
		function d(b, c, d) {
			var e, f, g, h, i, j, k;
			for (e = "horizontal" == b.scroll ? b.panelWidth : b.panelHeight, f = Math.ceil(c / e) + 5, g = Math.ceil((Math.abs(d) + c) / e) + 1, f = g - f, f = 0 > f ? 0 : f, j = f; g > j && j < b.panels.length; j++) k = b.panels[j], k.activePanel || (h = new a.Viewer({
				id: k.id,
				...
				blendTime: 0,
				animationTime: 0
			}), h.displayRegion = a.makeNeutralElement("textarea"), h.displayRegion.id = k.id + "-displayregion", h.displayRegion.className = "displayregion", i = h.displayRegion.style, i.position = "relative", i.top = "0px", i.left = "0px", i.fontSize = "0px", i.overflow = "hidden", i.float = "left", i.cssFloat = "left", i.styleFloat = "left", i.zIndex = 999999999, i.cursor = "default", i.width = b.panelWidth - 4 + "px", i.height = b.panelHeight - 4 + "px", h.displayRegion.innerTracker = new a.MouseTracker({
				element: h.displayRegion,
				startDisabled: !0
			}), k.getElementsByTagName("div")[0].appendChild(h.displayRegion), k.activePanel = !0)
		}
		...
		a.ReferenceStrip = function(j) {
			...
			for (j.id || (j.id = "referencestrip-" + a.now(), this.element = a.makeNeutralElement("div"), this.element.id = j.id, this.element.className = "referencestrip"), j = a.extend(!0, {
				...
				}), j.width && j.height ? (this.element.style.width = j.width + "px", this.element.style.height = j.height + "px", o.addControl(this.element, {
					anchor: a.ControlAnchor.BOTTOM_LEFT
				})) : "horizontal" == j.scroll ? (this.element.style.width = p.x * j.sizeRatio * o.tileSources.length + 12 * o.tileSources.length + "px", this.element.style.height = p.y * j.sizeRatio + "px", o.addControl(this.element, {
					anchor: a.ControlAnchor.BOTTOM_LEFT
				})) : (this.element.style.height = p.y * j.sizeRatio * o.tileSources.length + 12 * o.tileSources.length + "px", this.element.style.width = p.x * j.sizeRatio + "px", o.addControl(this.element, {
					anchor: a.ControlAnchor.TOP_LEFT
				})), this.panelWidth = p.x * this.sizeRatio + 8, this.panelHeight = p.y * this.sizeRatio + 8, this.panels = [], m = 0; m < o.tileSources.length; m++) k = a.makeNeutralElement("div"), k.id = this.element.id + "-" + m, k.style.width = n.panelWidth + "px", k.style.height = n.panelHeight + "px", k.style.display = "inline", k.style.float = "left", k.style.cssFloat = "left", k.style.styleFloat = "left", k.style.padding = "2px", a.setElementTouchActionNone(k), k.innerTracker = new a.MouseTracker({
				element: k,
				clickTimeThreshold: this.clickTimeThreshold,
				clickDistThreshold: this.clickDistThreshold,
				pressHandler: function(b) {
			...
			d(this, "vertical" == this.scroll ? p.y : p.y, 0), this.setFocus(0)
	...
	function(a) {
		...
		a.Spring = function(b) {
			...
			}), a.extend(!0, this, b), this.current = {
			...
			resetTo: function(a) {
				this.target.value = a, this.target.time = this.current.time, this.start.value = this.target.value, this.start.time = this.target.time
			},
			springTo: function(a) {
				this.start.value = this.current.value, this.start.time = this.current.time, this.target.value = a, this.target.time = this.start.time + 1e3 * this.animationTime
			},
			shiftBy: function(a) {
				this.start.value += a, this.target.value += a
			},
			update: function() {
				this.current.time = a.now(), this.current.value = this.current.time >= this.target.time ? this.target.value : this.start.value + (this.target.value - this.start.value) * b(this.springStiffness, (this.current.time - this.start.time) / (this.target.time - this.start.time))
			}
		}
	}(OpenSeadragon),
	function(a) {
		...
		function c(a, b, c) {
			var d;
			a.jobsInProgress--, (!a.jobLimit || a.jobsInProgress < a.jobLimit) && a.jobQueue.length > 0 && (d = a.jobQueue.shift(), d.start()), c(b.image)
		}
		b.prototype = {
			start: function() {
				var a = this;
				this.image = new Image, this.crossOriginPolicy !== !1 && (this.image.crossOrigin = this.crossOriginPolicy), this.image.onload = function() {
					a.finish(!0)
				}, this.image.onabort = this.image.onerror = function() {
					a.finish(!1)
				}, this.jobId = window.setTimeout(function() {
					a.finish(!1)
				}, this.timeout), this.image.src = this.src
			},
			finish: function(a) {
	...
	function(a) {
		...
		a.Tile = function(a, b, c, d, e, f) {
			...
			unload: function() {
				this.imgElement && this.imgElement.parentNode && this.imgElement.parentNode.removeChild(this.imgElement), this.element && this.element.parentNode && this.element.parentNode.removeChild(this.element), b[this.url] && delete b[this.url], this.element = null, this.imgElement = null, this.image = null, this.loaded = !1, this.loading = !1
			}
		}
	}(OpenSeadragon),
	function(a) {
		a.OverlayPlacement = {
			...
			destroy: function() {
				var a = this.element,
					b = this.style;
				a.parentNode && (a.parentNode.removeChild(a), a.prevElementParent && (b.display = "none", document.body.appendChild(a))), this.onDraw = null, b.top = "", b.left = "", b.position = "", this.scales && (b.width = "", b.height = "")
			},
			drawHTML: function(b, c) {
				var d, e, f = this.element,
					...
					h = this.scales,
					i = c.degrees,
					j = c.pixelFromPoint(this.bounds.getTopLeft(), !0);
				if (f.parentNode != b && (f.prevElementParent = f.parentNode, f.prevNextSibling = f.nextSibling, b.appendChild(f), this.size = a.getElementSize(f)), d = h ? c.deltaPixelsFromPoints(this.bounds.getSize(), !0) : this.checkResize ? a.getElementSize(f) : this.size, this.position = j, this.size = d, this.adjust(j, d), j = j.apply(Math.floor), d = d.apply(Math.ceil), 0 !== i && this.scales) {
					e = new a.Point(d.x / 2, d.y / 2);
					var k = new a.Point(c.viewer.drawer.canvas.width / 2, c.viewer.drawer.canvas.height / 2);
					j = j.plus(e).rotate(i, k).minus(e), d = d.rotate(i, new a.Point(0, 0)), d = new a.Point(Math.abs(d.x), Math.abs(d.y))
				}
				this.onDraw ? this.onDraw(j, d, f) : (g.left = j.x + "px", g.top = j.y + "px", g.position = "absolute", g.display = "block", h && (g.width = d.x + "px", g.height = d.y + "px"))
			},
			update: function(b, c) {
				this.scales = b instanceof a.Rect, this.bounds = new a.Rect(b.x, b.y, b.width, b.height), this.placement = b instanceof a.Point ? c : a.OverlayPlacement.TOP_LEFT
			}
		}
	}(OpenSeadragon),
	function(a) {
		function b(b) {
			b.updateAgain = !1, b.viewer && b.viewer.raiseEvent("update-viewport", {});
			...
			if (b.canvas.innerHTML = "", b.useCanvas && ((b.canvas.width != r.x || b.canvas.height != r.y) && (b.canvas.width = r.x, b.canvas.height = r.y), b.context.clearRect(0, 0, r.x, r.y)), 90 === y || 270 === y) {
				var z = s.rotate(y);
				t = z.getTopLeft(), u = z.getBottomRight()
			} else if (0 !== y) {
				var A = s.rotate(90);
				s.x -= A.width / 2, s.y -= A.height / 2, s.width += A.width, s.height += A.height, t = s.getTopLeft(), u = s.getBottomRight()
			}
			if (!(!b.wrapHorizontal && (u.x < 0 || t.x > 1) || !b.wrapVertical && (u.y < 0 || t.y > b.normHeight))) {
				b.wrapHorizontal || (t.x = Math.max(t.x, 0), u.x = Math.min(u.x, 1)), b.wrapVertical || (t.y = Math.max(t.y, 0), u.y = Math.min(u.y, b.normHeight)), w = Math.min(w, x);
				var B;
				for (e = x; e >= w; e--) {
					if (B = !1, g = b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(e), !0).x, !o && g >= b.minPixelRatio || e == w) B = !0, o = !0;
					else if (!o) continue;
					if (h = b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(e), !1).x, i = b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(Math.max(b.source.getClosestLevel(b.viewport.containerSize) - 1, 0)), !1).x, j = b.immediateRender ? 1 : i, k = Math.min(1, (g - .5) / .5), m = j / Math.abs(j - h), n = c(b, o, B, e, k, m, t, u, p, n), l(b.coverage, e)) break
				}
				q(b, b.lastDrawn), n && (f(b, n, p), b.updateAgain = !0)
			}
		}
		...
		function c(a, b, c, e, f, g, h, i, j, k) {
			...
			for (a.viewer && a.viewer.raiseEvent("update-level", {
					...
					currenttime: j,
					best: k
				}), n = a.source.getTileAtPoint(e, h), p = a.source.getTileAtPoint(e, i), q = a.source.getNumTiles(e), o(a.coverage, e), a.wrapHorizontal || (p.x = Math.min(p.x, q.x - 1)), a.wrapVertical || (p.y = Math.min(p.y, q.y - 1)), l = n.x; l <= p.x; l++)
				for (m = n.y; m <= p.y; m++) k = d(a, c, b, l, m, e, f, g, r, q, j, k);
			return k
		}
		...
		function d(a, b, c, d, f, g, h, k, l, o, q, r) {
			...
			if (a.viewer && a.viewer.raiseEvent("update-tile", {
					tile: s
				}), n(a.coverage, g, d, f, !1), !s.exists) return r;
			if (c && !t && (m(a.coverage, g, d, f) ? n(a.coverage, g, d, f, !0) : t = !0), !t) return r;
			if (i(s, a.source.tileOverlap, a.viewport, l, k), s.loaded) {
				var u = j(a, s, d, f, g, h, q);
				u && (a.updateAgain = !0)
			} else s.loading || (r = p(r, s));
			return r
		}

		function e(b, c, d, e, f, g, h, i) {
			var j, k, l, m, n, o;
			return f[d] || (f[d] = {}), f[d][b] || (f[d][b] = {}), f[d][b][c] || (j = (h.x + b % h.x) % h.x, k = (h.y + c % h.y) % h.y, l = e.getTileBounds(d, j, k), m = e.tileExists(d, j, k), n = e.getTileUrl(d, j, k), l.x += 1 * (b - j) / h.x, l.y += i * (c - k) / h.y, f[d][b][c] = new a.Tile(d, b, c, l, m, n)), o = f[d][b][c], o.lastTouchTime = g, o
		}

		function f(a, b, c) {
			a.viewport.collectionMode ? (a.midUpdate = !1, g(a, b, c)) : (b.loading = !0, a.imageLoader.addJob({
				src: b.url,
				crossOriginPolicy: a.crossOriginPolicy,
				callback: function(d) {
					g(a, b, c, d)
		...
		function g(b, c, d, e) {
			if (c.loading = !1, e || b.viewport.collectionMode) {
				if (d < b.lastResetTime) return void a.console.log("Ignoring tile %s loaded before reset: %s", c, c.url)
			} else if (a.console.log("Tile %s failed to load: %s", c, c.url), !b.debugMode) return void(c.exists = !1);
			c.loaded = !0, c.image = e, b.tilesLoaded.length < b.maxImageCacheCount ? b.tilesLoaded[b.tilesLoaded.length] = c : b.midUpdate ? window.setTimeout(function() {
				h(c, b)
			}, 1) : h(c, b), b.updateAgain = !0
		}

		function h(a, b) {
			var c, d, e, f, g, h, i = b.tilesLoaded.length,
				j = (Math.ceil(Math.log(b.source.getTileSize(a.level)) / Math.log(2)), null),
				k = -1;
			for (c = b.tilesLoaded.length - 1; c >= 0; c--) d = b.tilesLoaded[c], d.level <= b.cutoff || d.beingDrawn || (j ? (e = d.lastTouchTime, f = j.lastTouchTime, g = d.level, h = j.level, (f > e || e == f && g > h) && (j = d, k = c)) : (j = d, k = c));
			j && k >= 0 && (j.unload(), i = k), b.tilesLoaded[i] = a
		}
		...
		function i(b, c, d, e, f) {
			var g = b.bounds.getTopLeft(),
				...
				m = j.plus(l.divide(2)),
				n = e.distanceTo(m);
			c || (k = k.plus(new a.Point(1, 1))), b.position = i, b.size = k, b.distance = n, b.visibility = f
		}

		function j(a, b, c, d, e, f, g) {
			var h, i, j = 1e3 * a.blendTime;
			if (b.blendStart || (b.blendStart = g), h = g - b.blendStart, i = j ? Math.min(1, h / j) : 1, a.alwaysBlend && (i *= f), b.opacity = i, a.lastDrawn.push(b), 1 == i) n(a.coverage, e, c, d, !0);
		...
		function r(a, b, c, d) {
			var e = b.width / 2,
				...
				g = a.position.x - e,
				h = a.position.y - f;
			c.save(), c.translate(e, f), c.rotate(Math.PI / 180 * d), a.position.x = g, a.position.y = h
		}
		...
		a.Drawer = function(b) {
			...
			setOpacity: function(b) {
				return this.opacity = b, a.setElementOpacity(this.canvas, this.opacity, !0), this
			},
			getOpacity: function() {
				return this.opacity
			},
			...
			reset: function() {
				return k(this), this.lastResetTime = a.now(), this.updateAgain = !0, this
			},
			update: function() {
				return this.midUpdate = !0, b(this), this.midUpdate = !1, this
			},
			canRotate: function() {
				return this.useCanvas
			},
			destroy: function() {
				for (var a = 0; a < this.tilesLoaded.length; ++a) this.tilesLoaded[a].unload();
	...
	function(a) {
		a.Viewport = function(b) {
			...
			c.length && c[0] instanceof a.Point && (b = {
				...
				contentSize: c[1],
				config: c[2]
			}), b.config && (a.extend(!0, b, b.config), delete b.config), a.extend(!0, this, {
				containerSize: null,
				contentSize: null,
				zoomPoint: null,
				viewer: null,
			...
			}, b), this.centerSpringX = new a.Spring({
				initial: 0,
				...
				springStiffness: this.springStiffness,
				animationTime: this.animationTime
			}), this.resetContentSize(this.contentSize), this.goHome(!0), this.update()
		}, a.Viewport.prototype = {
			resetContentSize: function(b) {
				return this.contentSize = b, this.contentAspectX = this.contentSize.x / this.contentSize.y, this.contentAspectY = this.contentSize.y / this.contentSize.x, this.fitWidthBounds = new a.Rect(0, 0, 1, this.contentAspectY), this.fitHeightBounds = new a.Rect(0, 0, this.contentAspectY, this.contentAspectY), this.homeBounds = new a.Rect(0, 0, 1, this.contentAspectY), this.viewer && this.viewer.raiseEvent("reset-size", {
					contentSize: b
				}), this
			},
			...
			getCenter: function(b) {
				...
				return b ? k : this.zoomPoint ? (c = this.pixelFromPoint(this.zoomPoint, !0), d = this.getZoom(), e = 1 / d, f = e / this.getAspectRatio(), g = new a.Rect(k.x - e / 2, k.y - f / 2, e, f), h = this.zoomPoint.minus(g.getTopLeft()).times(this.containerSize.x / g.width), i = h.minus(c), j = i.divide(this.containerSize.x * d), l.plus(j)) : l
			},
			getZoom: function(a) {
			...
			_applyBoundaryConstraints: function(b, c) {
				var d, e, f, g, h, i, j = 0,
					k = 0,
					l = new a.Rect(b.x, b.y, b.width, b.height);
				return d = this.visibilityRatio * l.width, e = this.visibilityRatio * l.height, f = l.x + l.width, g = 1 - l.x, h = l.y + l.height, i = this.contentAspectY - l.y, this.wrapHorizontal || (d > f && (j = d - f), d > g && (j = j ? (j + g - d) / 2 : g - d)), this.wrapVertical || (e > h && (k = e - h), e > i && (k = k ? (k + i - e) / 2 : i - e)), (j || k || c) && (l.x += j, l.y += k, l.width > 1 && (l.x = .5 - l.width / 2), l.height > this.contentAspectY && (l.y = this.contentAspectY / 2 - l.height / 2)), this.viewer && this.viewer.raiseEvent("constrain", {
					immediately: c
				}), l
			},
			applyConstraints: function(a) {
				var b, c, d = this.getZoom(),
					e = Math.max(Math.min(d, this.getMaxZoom()), this.getMinZoom());
				return d != e && this.zoomTo(e, this.zoomPoint, a), b = this.getBounds(), c = this._applyBoundaryConstraints(b, a), (b.x !== c.x || b.y !== c.y || a) && this.fitBounds(c, a), this
			},
			...
			fitVertically: function(a) {
				...
				return this.wrapHorizontal && (b.x = (1 + b.x % 1) % 1, this.centerSpringX.resetTo(b.x), this.centerSpringX.update()), this.wrapVertical && (b.y = (this.contentAspectY + b.y % this.contentAspectY) % this.contentAspectY, this.centerSpringY.resetTo(b.y), this.centerSpringY.update()), this.fitBounds(this.fitHeightBounds, a)
			},
			fitHorizontally: function(a) {
				var b = this.getCenter();
				return this.wrapHorizontal && (b.x = (this.contentAspectX + b.x % this.contentAspectX) % this.contentAspectX, this.centerSpringX.resetTo(b.x), this.centerSpringX.update()), this.wrapVertical && (b.y = (1 + b.y % 1) % 1, this.centerSpringY.resetTo(b.y), this.centerSpringY.update()), this.fitBounds(this.fitWidthBounds, a)
			},
			panBy: function(b, c) {
				var d = new a.Point(this.centerSpringX.target.value, this.centerSpringY.target.value);
				return b = b.rotate(-this.degrees, new a.Point(0, 0)), this.panTo(d.plus(b), c)
			},
			panTo: function(a, b) {
			...
			zoomTo: function(b, c, d) {
				return this.zoomPoint = c instanceof a.Point && !isNaN(c.x) && !isNaN(c.y) ? c : null, d ? this.zoomSpring.resetTo(b) : this.zoomSpring.springTo(b), this.viewer && this.viewer.raiseEvent("zoom", {
					zoom: b,
					refPoint: c,
					immediately: d
				}), this
			...
			setRotation: function(a) {
				return this.viewer && this.viewer.drawer.canRotate() ? (a = (a + 360) % 360, this.degrees = a, this.viewer.forceRedraw(), null !== this.viewer && this.viewer.raiseEvent("rotate", {
					degrees: a
				}), this) : this
			},
			...
			resize: function(b, c) {
				var d, e = this.getBounds(),
					f = e;
				return this.containerSize = new a.Point(b.x, b.y), c && (d = b.x / this.containerSize.x, f.width = e.width * d, f.height = f.width / this.getAspectRatio()), this.viewer && this.viewer.raiseEvent("resize", {
					newContainerSize: b,
					maintain: c
				}), this.fitBounds(f, !0)
			},
			update: function() {
				var a, b, c, d, e = this.centerSpringX.current.value,
					f = this.centerSpringY.current.value,
					g = this.zoomSpring.current.value;
				return this.zoomPoint && (a = this.pixelFromPoint(this.zoomPoint, !0)), this.zoomSpring.update(), this.zoomPoint && this.zoomSpring.current.value != g ? (b = this.pixelFromPoint(this.zoomPoint, !0), c = b.minus(a), d = this.deltaPointsFromPixels(c, !0), this.centerSpringX.shiftBy(d.x), this.centerSpringY.shiftBy(d.y)) : this.zoomPoint = null, this.centerSpringX.update(), this.centerSpringY.update(), this.centerSpringX.current.value != e || this.centerSpringY.current.value != f || this.zoomSpring.current.value != g
			},
			...
			imageToViewportRectangle: function(b, c, d, e) {
				var f, g, h;
				return 1 == arguments.length ? (h = b, this.imageToViewportRectangle(h.x, h.y, h.width, h.height)) : (f = this.imageToViewportCoordinates(b, c), g = this.imageToViewportCoordinates(d, e), new a.Rect(f.x, f.y, g.x, g.y))
			},
			viewportToImageRectangle: function(b, c, d, e) {
				var f, g, h;
				return 1 == arguments.length ? (h = b, this.viewportToImageRectangle(h.x, h.y, h.width, h.height)) : (f = this.viewportToImageCoordinates(b, c), g = this.viewportToImageCoordinates(d, e), new a.Rect(f.x, f.y, g.x, g.y))
			},
