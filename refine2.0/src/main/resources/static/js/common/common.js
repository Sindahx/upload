...
common.age=function(birthday,indate){
    ...
    if(indate == ""){
        ...
        endTime = new Date(Date.parse(indate.replace(/-/g, "/"))).getTime();
    }
...
common.mMessege=function(type,text){  //type:1为成功，0为失败，2为警告 3位置在顶部   4位置在中间不消失   text:为内容
    ...
    var html='';
    html+='<div class="middle_messege" style="z-index: 9999999999999999999999999999999999999999999999991">';
...
common.decide=function(title,fn){
    ...
    thml+='<div class="modal-dialog small-dialog" style="width: 500px;">';
    ...
    thml+='<button type="button" class="btn btn-default" id="Mfalse" data-dismiss="modal">关闭</button>';
...
//设置居中
common.GetUrlRelativePath = function (url) {
...
common.ylImgLayer = function (src) {
    var mask='<div id="imgMask" style="margin:0;padding:0;border:none;width:100%;height:100%;background:#000;opacity:0.9;filter:alpha(opacity=90);z-index:9999;position:fixed;top:0;left:0;"></div>';
    var loadHtml='';
    loadHtml='<div id="ylImgDiv" style="position:fixed;z-index:10049;overflow:hidden;left:0;top:0;bottom:0;left: 0;right:0;"><img style="position:absolute;" src="'+src+'" /></div>';
    $("body").append(mask);
    ...
    $("#ylImgDiv img").load(function(){
        ...
        $("#ylImgDiv img").css({'top':'21%','margin':'0 auto','left':0,'right':0,'max-width':'700px'});
    });
    var fshtml='<div id="fsDiv" style="position:fixed;z-index:10049;bottom:3%;left:50%;margin:0 0 0 -75px;width:150px;height:60px;padding:10px;background:rgba(0,0,0,0.8);border-radius:30px;">';
    ...
    var pencentHtml='<div id="ImgPencent" style="position:absolute;border:solid blue 3px; text-align:center;color:#fff;font-size:18px;box-shadow: 0 0 3px #666;border-radius: 3px;background:rgba(0,0,0,0.5);top:50%;left:50%;width:100px;margin-left:-50px;height:40px;line-height:40px;z-index:10049;margin-top:20px;display:none"></div>';
    ...
    var Chtml='<a href="javascript:;" class="jlfont closeImg" >&#xe62a;</a>  ';
    $("body").append(Chtml);
