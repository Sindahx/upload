	...
	Datetimepicker.prototype = {
		...
		_attachEvents: function () {
			...
			if (this.isInput) { // single input
				this._events = [
					[this.element, {
						click:   $.proxy(this.show, this),  //old event is "focus"
		...
		place: function () {
			...
			if(this.container !='body'){
				top = top - containerOffset.top + $(this.container).scrollTop();
			}else{
		...
		fill: function () {
			...
			var d = new Date(this.viewDate),
				...
				endMonth = this.endDate !== Infinity ? this.endDate.getUTCMonth()  + 3 : Infinity,//最大日期的限制 months.slice(endMonth).addClass('disabled'); 处  months中前面多了两个span 加上去掉前面的多余的span
